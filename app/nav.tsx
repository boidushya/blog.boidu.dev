...
const Navbar: NextPage = () => {
  return (
    <nav className="z-10 fixed flex items-center justify-between w-[48rem] py-8 mx-auto my-0 bg-gradient-to-b from-accent-900/100 via-accent-900/95 to-accent-900/90 backdrop-saturate-50 backdrop-brightness-75">
