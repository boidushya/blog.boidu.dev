const socialLinks = [
  {
    name: "GitHub",
    url: "https://github.com/boidushya",
    icon: (
  ...
  {
    name: "Twitter",
    url: "https://twitter.com/boidushya",
    icon: (
      <svg role="img" viewBox="0 0 24 24" xmlns="http://www.w3.org/2000/svg">
        <title>Twitter</title>
  ...
  {
    name: "LinkedIn",
    url: "https://www.linkedin.com/in/boidushya",
    icon: (
      <svg role="img" viewBox="0 0 24 24" xmlns="http://www.w3.org/2000/svg">
  ...
  {
    name: "RSS",
    url: "https://blog.boidu.dev/rss.xml",
    icon: (
      <svg xmlns="http://www.w3.org/2000/svg" viewBox="0 0 24 24" fill="currentColor" className="!w-5 !h-5">
        <path
          fillRule="evenodd"
